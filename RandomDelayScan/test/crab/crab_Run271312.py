...
config.General.requestName  = 'delaySCAN_Express_Run271312'
...
config.Data.lumiMask      = '/afs/cern.ch/user/r/rgerosa/work/TrackerDAQ/DELAY_SCAN/CMSSW_8_0_4/src/DPGAnalysis/SiStripTools/test/crab/json_271312.txt'
