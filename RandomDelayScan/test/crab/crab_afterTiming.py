...
config.General.requestName  = 'trackSoverN_ZeroBias_afterTiming'
...
config.Data.lumiMask      = '/afs/cern.ch/user/r/rgerosa/work/TrackerDAQ/DELAY_SCAN/CMSSW_8_0_14/src/DPGAnalysis/SiStripTools/test/crab/json_afterTiming.txt'
