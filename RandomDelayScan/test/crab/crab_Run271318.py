...
config.General.requestName  = 'delaySCAN_Express_Run271318'
...
config.Data.lumiMask      = '/afs/cern.ch/user/r/rgerosa/work/TrackerDAQ/DELAY_SCAN/CMSSW_8_0_4/src/DPGAnalysis/SiStripTools/test/crab/json_271318.txt'
